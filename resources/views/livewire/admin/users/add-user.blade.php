<form wire:submit.prevent="saveUser" method="POST" class="mb-3">
    <div class="modal-body">
        ...
        <div class="row g-2">
            <div class="col mb-0">
                ...
                <input wire:model="user.date_of_birth" type="date" min="5" max="99" lang="en" id="DOBWithTitle" class="form-control" placeholder=".." required />
            ...
            {{-- <div class="col mb-0">
                ...
                <select wire:model="user.gender" id="genderWithTitle" class="form-select text-capitalize" required>
        ...
        {{-- <div class="row g-2">
            <div class="col mb-0">
                ...
                <input wire:model="user.mobile_number" type="text" id="mobileWithTitle" class="form-control"
                    placeholder="{{ __('Add full mobile number') }}: 00966" required />
        ...
        <div class="row g-2">
            ...
            <div class="col mb-0">
                <label for="passwordConWithTitle" class="form-label">{{ __('Password Confirmation') }}</label>
